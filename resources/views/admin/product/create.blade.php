        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title-desc">Product Create</h4>
                                ...
                                <div class="mb-3 row">
                                    <div class="language-container" lang="az" style="display: flex;">
                                        <div class="col-md-10">
                                            ...
                                            <input class="form-control" type="text" name="title[az]" value=""
                                                id="input-az">
                                        </div>
                                    </div>
                                    ...
                                    <div class="language-container" lang="az" style="display: flex;">
                                        <div class="col-md-10">
                                            <label for="input-ru" class="form-label">Description az</label>
                                            <textarea class="form-control" type="text" name="description[az]" value="" id="input-az"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="language-container" lang="ru" style="display: none;">
                                        <div class="col-md-10">
                                            ...
                                            <input class="form-control" type="text" name="title[ru]" value=""
                                                id="input-ru">
                                        </div>
                                    </div>
                                    ...
                                    <div class="language-container" lang="ru" style="display: none;">
                                        <div class="col-md-10">
                                            <label for="description-ru" class="form-label">Description ru</label>

                                            <textarea class="form-control" type="text" name="description[ru]" value="" id="input-ru"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="language-container" lang="en" style="display: none;">
                                        <div class="col-md-10">
                                            ...
                                            <input class="form-control" type="text" name="title[en]" value=""
                                                id="input-ru">
                                        </div>
                                    </div>
                                    ...
                                    <div class="language-container" lang="en" style="display: none;">
                                        <div class="col-md-10">
                                            <label for="description-ru" class="form-label">Description en</label>

                                            <textarea class="form-control" type="text" name="description[en]" value="" id="input-ru"></textarea>
                                        </div>
                                    </div>
