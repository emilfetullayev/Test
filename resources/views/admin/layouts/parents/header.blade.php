            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect"
                        ...
                        <div class="custom-sel">
                            <a class="selected" href="#">{{ app()->getLocale() }} &nbsp;<i class="fa fa-caret-down lightblue" aria-hidden="true"></i></a>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="custom-sel">
                        ...
                        <a class="hidden" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">  {{ $properties['native'] }}</a>
                        @endif
